    ...
    def initRouters(self):
        ...
        def login():
            ...
            if form.validate_on_submit():
                user = MainDB.Profile.select().where(fn.lower(MainDB.Profile.Username) == form.login.data.lower())
        ...
        @self.app.route('/api/getPlayers/')
        @self.app.route('/api/getPlayers/<searchStr>')
        @login_required
