...
from balancer_models.models import Profile, Role, Workspace, WorkspaceProfile
from balancer_models.permissions import Permissions
from balancer_models.repository import (LobbyRepository, RoleRepository,
...
class WorkspaceProfileService:
    def __init__(self, role_repository: RoleRepository, workspace_repository: WorkspaceRepository, workspace_profile_repository: WorkspaceProfileRepository, lobby_repository: LobbyRepository) -> None:
